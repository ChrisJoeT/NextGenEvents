...
$sql_select = "SELECT * FROM booking WHERE booking_status='Pending'";
...
<center>
    ...
    if (isset($_POST['approve'])) {
        ...
        $select = "UPDATE booking SET booking_status = 'Approved' WHERE si_number = '$si_number'";

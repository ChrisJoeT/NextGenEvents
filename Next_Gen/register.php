...
<div class="grid">
  ...
  <form action="" method="POST" class="form login">
    ...
    <div class="form__field">
      ...
      <input autocomplete="username" id="login__username" type="text" name="name" class="form__input" placeholder="Full Name" required>
    </div>
  ...
  <p class="text--center"><a href="login.php">Login</a> <svg class="icon">
...
$conn=mysqli_connect("localhost","root","","Next_Gen");
if(!$conn)
echo "can't connect";

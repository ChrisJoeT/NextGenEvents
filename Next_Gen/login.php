...
<div class="grid">
  ...
  <p class="text--center">Not a member? <a href="register.php">Sign up now</a> <svg class="icon">
    ...
    <p class="text--center"><form action="register.php" method="post" ><input id="logout" type="submit" name="delete" value="logout"></form><svg class="icon">
      <use xlink:href="#icon-arrow-right"></use>
    </svg></p>   
...
if (isset($_POST['submit'])) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        if ($email== $dbemail && $password == $dbPassword) {
            ...
            header("Location: index.php?email=$dbemail");
            exit();
        }
    }
